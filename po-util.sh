...
build_pi()
{
  ...
  then
    docker run --rm -i -v $BASE_FIRMWARE/firmware:/firmware -v $FIRMWAREDIR:/input -v $FIRMWAREDIR/../bin:/output particle/buildpack-raspberrypi && echo && MESSAGE="Sucessfully built firmware for Raspberry Pi" ; blue_echo || ( MESSAGE="Build failed." ; red_echo)
  else
